...
export default {
  ...
  methods: {
    ...
    saveCSV() {
      ...
      const url = `http://192.168.6.79:4002/save_csv/${this.sectionNumber}`;
    ...
    saveCaption() {
      if (!this.tableCaption == '') {
        ...
        const url = 'http://192.168.6.79:4002/save_text/' + this.sectionNumber;
    ...
    uploadFile(){
      ...
      let formData = new FormData();
        ...
        const url = `http://192.168.6.79:4002/add_csv/${this.sectionNumber}`;
