...
export default {
  ...
  methods: {
    ...
    saveCSV() {
      ...
      const url = `http://192.168.6.79:4307/save_csv/${this.sectionNumber}`;
    ...
    saveCaption() {
      if (!this.tableCaption == '') {
        ...
        const url = 'http://192.168.6.79:4307/save_text/' + this.sectionNumber;
    ...
    uploadFile(){
      ...
      let formData = new FormData();
        ...
        const url = `http://192.168.6.79:4307/add_csv/${this.sectionNumber}`;
